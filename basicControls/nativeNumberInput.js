...
(function (nativeNumberInput) {
    ...
    function initialize(Work, Sheet, Patch, installStyle, reactively, $, define$Property, fill$fromJSON, JSONfor$, html) {
        installStyle(`
    ...
    nativeNumberInput.initialize = initialize;
})(nativeNumberInput || (nativeNumberInput = {}));
